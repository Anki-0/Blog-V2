...
const LoaderC = styled.div`
  ...
  @keyframes animloader {
    ...
    12% {
      box-shadow: 0 24px white, 24px 24px rgba(255, 255, 255, 0), 24px 48px rgba(255, 255, 255, 0),
    ...
    75% {
      box-shadow: 0 24px rgba(255, 255, 255, 0), 24px 24px rgba(255, 255, 255, 0), 24px 48px white,
        0px 48px white;
    }
    87% {
      box-shadow: 0 24px rgba(255, 255, 255, 0), 24px 24px rgba(255, 255, 255, 0),
...
export default function Loader(): JSX.Element {
  return <LoaderC>Loading...</LoaderC>;
}
